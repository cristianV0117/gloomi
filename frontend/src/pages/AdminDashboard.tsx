    ...
    <div className="mx-auto w-full max-w-4xl py-8">
      <div className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center rounded-2xl border border-zinc-700 px-4 py-2.5 text-sm text-zinc-200 hover:bg-zinc-900"
        >
          Nuevo Gloomi
        </Link>
      </div>
      ...
      <section className="mb-10 rounded-2xl border border-zinc-800 bg-zinc-950/50 p-6">
        <h2 className="font-display mb-4 text-lg tracking-wide">
          Portada (inicio)
        </h2>
        ...
        <div className="mb-6 space-y-3">
          <span className="block text-xs text-zinc-500">Imagen principal</span>
          ...
          {heroSource === 'product' ? (
            <div>
              <label className="mb-1 block text-xs text-zinc-500" htmlFor="hero-product">
              ...
              <select
                ...
                className="w-full max-w-md rounded-xl border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm outline-none focus:border-[color:var(--color-gloom-violet)]"
              >
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <label className="inline-flex cursor-pointer items-center justify-center rounded-xl border border-dashed border-zinc-600 bg-zinc-900/80 px-4 py-2.5 text-sm text-zinc-300 transition hover:border-[color:var(--color-gloom-violet)]">
                ...
                {settings?.heroCustomRelativeUrl ? (
                  <button
                    ...
                    disabled={homeSaving}
                    className="text-sm text-zinc-500 underline-offset-2 hover:text-red-300 hover:underline disabled:opacity-50"
                  >
        ...
        <div className="mb-6">
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            {([0, 1, 2] as const).map((i) => (
              <div key={i}>
                <label
                  className="mb-1 block text-[11px] text-zinc-600"
                  htmlFor={`feat-${i}`}
                >
                  Slot {i + 1}
                </label>
          ...
          <table className="w-full min-w-[36rem] text-left text-sm">
            ...
            <tbody>
              {products.map((p) => {
                ...
                return (
                  <tr key={p.slug} className="border-b border-zinc-800/80">
                    ...
                    <td className="py-3 pr-4 text-zinc-500">{p.slug}</td>
                    ...
                    <td className="py-3 text-right">
                      ...
                      <button
                        ...
                        className="text-red-400/90 hover:underline disabled:opacity-50"
                      >
